...
#    success, image = cap.read()
    ...
    if detection_result_list:
        ...
        for detected in detected_list:
            ...
            if category[0].category_name == "stop sign" and category[0].score > 0.5:
                print("stop")
            elif category[0].category_name == "person" and category[0].score > 0.5:
                print("stop, person")
            elif category[0].category_name != "" and category[0].score > 0.5:
                print(detected)
            else:
                print(fps_text)
